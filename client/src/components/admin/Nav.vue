    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
        <ul
          ...
          <li>
            <a href="#" class="block py-2 pl-3 pr-6 rounded md:bg-transparent font-bold md:p-0 hover:underline"
              aria-current="page"><router-link style="cursor: pointer; text-decoration: none" to="/"> Home
              </router-link></a>
          </li>
          <li>
            <a href="#"
              class="block py-2 pl-3 pr-4 rounded font-bold md:p-0 md:hover:bg-transparent hover:underline ease-linear duration-[10000]"><router-link
                style="cursor: pointer; text-decoration: none" to="/admin/role"> Addrole </router-link></a>
          </li>
          <li>
            <a href="#"
              class="block py-2 pl-3 pr-4 rounded font-bold md:p-0 md:hover:bg-transparent hover:underline"><router-link
                style="cursor: pointer; text-decoration: none" to="/admin/users">Alluser</router-link></a>
          </li>
        </ul>
      </div>
    </div>
