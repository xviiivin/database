                ...
                <ul
                    ...
                    <li>
                        <a href="#"
                            ...
                            aria-current="page"><router-link style="cursor: pointer; text-decoration: none" to="/">
                                Home
                            </router-link></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4  rounded  font-bold  md:p-0  md:hover:bg-transparent hover:underline">Alluser</a>
                    </li>
