                  ...
                  <div class="relative h-full w-full md:w-2/3 xl:w-1/3 flex items-center rounded-t-3xl bg-white">
                        <div class="w-full h-full p-8">
                              ...
                              <div v-for="(val, index) in DocInfo" :key="index">
                                    <div class="mb-3">
                                          <p class="text-xl font-bold mb-8 underline ml-8">{{ val.docname }}</p>
                                    </div>
                                    <div class="mx-5 lg:mx-10 mb-3">
                                          <div class="rounded-xl w-full h-[calc(100%+2rem)] group shadow-lg overflow-hidden ">
                                    ...
                                    <div class="mt-5">
                                          ...
                                          <div class="text-[#111727] ml-[20%]">
                                                <ul class="list-disc marker:text-sky-800 break-words font-semibold">
                                                      <li>Name  <span class="font-light text-[#111727] opacity-[60%] ml-10"> {{ val.docname }} </span></li>
                                                      <li>Expert  <span class="font-light text-[#111727] opacity-[60%] ml-5"> {{ val.specialist }} </span></li>
                                                      <li>Age   <span class="font-light text-[#111727] opacity-[60%] ml-12">{{ val.age }}</span></li>
                                                      <li>Gender   <span class="font-light text-[#111727] opacity-[60%] ml-5">{{ val.gender }}</span></li>
                                                      <li>Description   <span class="font-light text-[#111727] opacity-[60%] ml-5 "> {{ val.description }}</span></li>
                                                </ul>
                                          </div>
                                    </div>
                              </div>
